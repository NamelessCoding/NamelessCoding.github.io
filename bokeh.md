...
# **The focal point**
The focus point is the point that will be the most clear, essentially the way it works is that the point on the focal plane will be the least offset as the ray direction is towards the point on the focal plane. Once it passes the focus point the rays will diverge more and more away from one another, which will make it so the blur is bigger..
